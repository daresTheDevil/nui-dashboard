...
// Props in: none (uses v-model for Range)
// Emits out: update:modelValue: Range (via v-model)
//
// Renders a popover date range picker with preset ranges (7d, 14d, 30d, 3m, 6m, 1y)
// and a dual-month calendar.
