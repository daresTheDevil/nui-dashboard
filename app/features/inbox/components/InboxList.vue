...
// Props in: mails: Mail[] — see ../types.ts
// Emits out: update:modelValue: Mail | null (via v-model for selected mail)
//
// Renders a scrollable list of mail items with unread indicators and date formatting.
// Supports keyboard navigation (arrow up/down) to select mails.
