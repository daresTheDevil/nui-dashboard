 ...
 * GET /api/mails
 *
 * Returns the full list of mock email messages with sender info, subject, and body.
 *
 * Auth: not required
 * Query params: none
 * Body: none
 * Returns: Mail[] (typed inline — uses User-like sender objects)
 * Errors: none (always returns mock data)
 */
